...
const DICTS = {
  en: {
    ...
    'customer.servedBy': '{name} is serving you.',
    'customer.endChat': 'End conversation',
    'customer.ending': 'Ending…',
    'customer.endedTitle': 'Conversation ended',
    'customer.endedBody': 'Thanks for talking to us. You can start a new contact whenever you like.',
    ...
    'chat.ending': 'Ending…',
    'chat.newMessageFor': 'New message from {name}',
    'chat.sender.CUSTOMER': 'Customer',
    'chat.sender.AGENT': 'Agent',

    'admin.title': 'Live conversations',
    'admin.subtitle': 'Watch every customer↔agent dialog in real time.',
    'admin.noConversations': 'No conversations in progress.',
    'admin.watching': 'Watching {customer} ↔ {agent}',
    'admin.reset': 'End all',
    'admin.resetting': 'Ending…',
    'admin.resetConfirm': 'End every interaction and clear all queues? This frees every slot.',
  ...
  pt: {
    ...
    'customer.servedBy': '{name} está te atendendo.',
    'customer.endChat': 'Encerrar atendimento',
    'customer.ending': 'Encerrando…',
    'customer.endedTitle': 'Atendimento encerrado',
    'customer.endedBody': 'Obrigado por falar com a gente. Você pode iniciar um novo atendimento quando quiser.',
    ...
    'chat.send': 'Enviar',
    'chat.endConversation': 'Encerrar atendimento',
    'chat.ending': 'Encerrando…',
    'chat.newMessageFor': 'Nova mensagem de {name}',
    'chat.sender.CUSTOMER': 'Cliente',
    'chat.sender.AGENT': 'Atendente',

    'admin.title': 'Conversas ao vivo',
    'admin.subtitle': 'Acompanhe cada diálogo cliente↔atendente em tempo real.',
    'admin.noConversations': 'Nenhuma conversa em andamento.',
    'admin.watching': 'Acompanhando {customer} ↔ {agent}',
    'admin.reset': 'Encerrar tudo',
    'admin.resetting': 'Encerrando…',
    'admin.resetConfirm': 'Encerrar todos os atendimentos e limpar todas as filas? Isso libera todas as vagas.',
