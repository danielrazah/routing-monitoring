...
public final class AgentMapper {
     ...
     */
    public static Agent toDomain(AgentJpaEntity entity, Set<UUID> activeInteractionIds) {
        return new Agent(entity.getId(), entity.getName(), entity.getTeamId(), activeInteractionIds);
    }
}
